...
SOURCE	= src/main.cpp src/fileio.cpp src/config.cpp src/formatting/global.cpp src/formatting/languages/python/formatter.cpp src/formatting/languages/c/formatter.cpp 
